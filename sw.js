...
const SHELL_ASSETS = [
  ...
  'js/core/LoadingManager.js?v=115', 'js/core/AudioManager.js?v=114', 'js/core/SceneManager.js?v=114',
  ...
  'js/minigames/TeaStationGame.js?v=2', 'js/minigames/StationGame.js?v=85', 'js/main.js?v=120',
